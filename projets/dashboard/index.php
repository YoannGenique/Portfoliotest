...
<html lang="fr">
    ...
    <a href="../../projets.php"><img style="background-color: white; border-radius: 10%; padding-right:3px" src="assets/img/retour.png" alt="retour au portfolio" width="50px"></a>
        ...
        <form action="assets/auth/authentification.php" method="POST" class="form-signin">
            ...
            <p style="color: white;">admin@admin.com - admin</p>
            <?php
